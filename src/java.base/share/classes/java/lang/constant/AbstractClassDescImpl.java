...
abstract class AbstractClassDescImpl implements ClassDesc {
     ...
     */
    protected AbstractClassDescImpl(String descriptor) {
    ...
    /**
     * Returns {@code true} if this {@linkplain AbstractClassDescImpl} is
     * equal to another {@linkplain AbstractClassDescImpl}.  Equality is
